<x-guest-layout>
    <form method="POST" action="{{ route('character.update', ['id' => $character->id]) }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full text-sm" type="text" name="name" :value="old('name')" placeholder="Lae'zel" autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <select id="class"  name="class" class="block mt-1 w-full dark:bg-gray-900 rounded dark:text-white form-select text-sm">
        ...
        <div class="mt-4">
            ...
            <select id="race" name="race" class="block mt-1 w-full form-select dark:bg-gray-900 rounded dark:text-white text-sm">
        ...
        <div class="mt-4">
            ...
            <select id="faction" name="faction" class="block mt-1 w-full form-select dark:bg-gray-900 rounded dark:text-white text-sm">
        ...
        <div class="mt-4">
            ...
            <textarea
                ...
                class="block mt-1 h-16 w-full form-input rounded-md shadow-sm dark:bg-gray-900 dark:text-white text-sm"
            ></textarea>
